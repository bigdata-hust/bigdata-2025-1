...
class DataLoader:
    ...
    def load_business_data(self):
        """Load and prepare business data from Kafka"""
        print("Loading business data from Kafka...")
        ...
        business_df = (
            ...
            .withColumn("value", from_json(
                col("value"), 
                ArrayType(self.schemas.business_schema())
            ))
    ...
    def load_review_data(self):
        """Load and prepare review data from Kafka"""
        print("Loading review data from Kafka...")
        ...
        review_df = (
            ...
            .withColumn("value", from_json(
                col("value"), 
                ArrayType(self.schemas.review_schema())
            ))
            .withColumn("value", explode(col("value")))
            .select("value.*")
    ...
    def load_user_data(self):
        """Load and prepare user data from Kafka"""
        print("Loading user data from Kafka...")
        ...
        user_df = (
            ...
            .withColumn("value", from_json(
                col("value"), 
                ArrayType(self.schemas.user_schema())
            ))
            .withColumn("value", explode(col("value")))
            .select("value.*")
